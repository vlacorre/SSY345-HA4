% Function retrieved from part HA1.1.2.
...
mu_y = A*mu_x + b; % The constant part will add a fixed offset to the mean of every x_i
Sigma_y = A*Sigma_x*A'; % Covariance with a constant is 0
